...
openssl x509 -noout -text -in /tmp/ca/user1/msp/cacerts/localhost-7054.pem
fabric-ca-client enroll -u http://admin:adminpw@localhost:7054
fabric-ca-client register --id.name 'User3@org1.example.com' --id.secret user3pw --id.type user --id.affiliation org1 --id.attrs 'abac.init=true,email=user3@org1.example.com'
export FABRIC_CA_CLIENT_HOME=/tmp/ca/User3\@org1.example.com
fabric-ca-client enroll -u http://User3@org1.example.com:user3pw@localhost:7054 --enrollment.attrs "abac.init,email"
openssl x509 -noout -text -in /tmp/ca/User3\@org1.example.com/msp/signcerts/cert.pem

cd $GOPATH/src/github.com/hyperledger/fabric-samples/basic-network/crypto-config/peerOrganizations/org1.example.com/users
cp -R User1\@org1.example.com User3\@org1.example.com
cd User3\@org1.example.com
rm -R msp/keystore
cp -R /tmp/ca/User3\@org1.example.com/msp/keystore msp
rm msp/admincerts/User1\@org1.example.com-cert.pem
cp /tmp/ca/User3\@org1.example.com/msp/signcerts/cert.pem msp/admincerts/User3\@org1.example.com-cert.pem
rm msp/signcerts/User1\@org1.example.com-cert.pem
cp /tmp/ca/User3\@org1.example.com/msp/signcerts/cert.pem msp/signcerts/User3\@org1.example.com-cert.pem
```
