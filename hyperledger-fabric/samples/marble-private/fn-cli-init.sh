...
. ./utils.sh
echo "install marble_private_cc on peer0 org1"
peer chaincode install -n marble_private_cc -v 1.0 -p github.com/chaincode/marble_private_cc

echo "install marble_private_cc on peer1 org1"
setGlobals 1 1
peer chaincode install -n marble_private_cc -v 1.0 -p github.com/chaincode/marble_private_cc

echo "install marble_private_cc on peer0 org2"
setGlobals 0 2
peer chaincode install -n marble_private_cc -v 1.0 -p github.com/chaincode/marble_private_cc

echo "install marble_private_cc on peer1 org2"
setGlobals 1 2
peer chaincode install -n marble_private_cc -v 1.0 -p github.com/chaincode/marble_private_cc

echo "instantiate marble_private_cc"
