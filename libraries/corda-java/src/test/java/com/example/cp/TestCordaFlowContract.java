...
//contract is created with dovetail definition
public class TestCordaFlowContract {
	...
	class MockIssueTxn implements ITransactionService {
		...
		public String getTransactionName() {
			// TODO Auto-generated method stub
			return "com.example.cp.IssueIOU";
		}
	...
	class MockTransferTxn implements ITransactionService {
		...
		public String getTransactionName() {
			// TODO Auto-generated method stub
			return "com.example.cp.TransferIOU";
		}
	...
	class MockSettleTxn implements ITransactionService {
		...
		public String getTransactionName() {
			// TODO Auto-generated method stub
			return "com.example.cp.SettleIOU";
		}
	...
	public void createIOU() {
		...
		iou = new IOU(java.time.Instant.now(), alice, bob, DOLLARS(100), DOLLARS(0), new UniqueIdentifier());
		contract = new IOUContract();
		...
		try {
			App app = AppCompiler.compileApp(txJson);
    	 		trigger = app.getTriggers().get("com.example.cp.IssueIOU");
		} catch (Exception e) {
